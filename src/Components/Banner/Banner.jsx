    ...
    return (
        <div className='bg-linear-to-b from-[#FFFFFF00] to-[#FFFFFFFF] w-11/12 border-2 rounded-3xl border-white mx-auto px-40 py-16 space-y-4 mt-10'>
            <div className='space-y-4'>
                <h1 className='font-extrabold text-5xl text-center'>Dependable Care, Backed by Trusted Professionals.</h1>
                ...
                < div className='text-center flex flex-col md:flex-col lg:flex-row justify-center gap-5 items-center'>
                    ...
                    <button>
                        <a className="btn rounded-[99px] bg-[#176AE5] text-white font-bold text-xl py-6 px-6">Search Now</a>
                    </button>
                </div>
            </div>
